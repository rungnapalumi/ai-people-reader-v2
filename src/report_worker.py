...
def _build_categories_from_result(result: Dict[str, Any], total: int) -> List[CategoryResult]:
    ...
    categories = [
        CategoryResult(
            ...
            scale=("high" if int(result["engaging_score"]) >= 4 else ("moderate" if int(result["engaging_score"]) == 3 else "low")),
        ...
        CategoryResult(
            ...
            scale=("high" if int(result["convince_score"]) >= 4 else ("moderate" if int(result["convince_score"]) == 3 else "low")),
        ...
        CategoryResult(
            ...
            scale=("high" if int(result["authority_score"]) >= 4 else ("moderate" if int(result["authority_score"]) == 3 else "low")),
