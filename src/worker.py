...
SKELETON_EDGES = [
    ...
    (mp_pose.PoseLandmark.LEFT_ELBOW, mp_pose.PoseLandMARK.LEFT_WRIST) if hasattr(mp_pose.PoseLandmark, "PoseLandMARK") else (mp_pose.PoseLandmark.LEFT_ELBOW, mp_pose.PoseLandmark.LEFT_WRIST),
